...
### 1.2.1 function
&emsp;Return the Log2|FC|, P value and differential expression Score of each gene. **diff_gene()** will return a $56269\times3$ data.frame which rows represent genes.
