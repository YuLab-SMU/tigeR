...
output:
  ...
  html_document:
    toc: yes
    df_print: paged
vignette: "%\\VignetteIndexEntry{Tumor immunolotherapy gene expression R packag} %\\usepackage[utf8]{inputenc}
  %\\VignetteEncoding{UTF-8} %\\VignetteEngine{knitr::rmarkdown}\n"
editor_options:
  markdown:
    wrap: sentence
---
...
|        response         | CR/PD/SD/CR/PR  |                                     The Immunotherapy response.                                      |              ✕              |
...
### 3.2.2 parameter  ***Model*** Machine learning model generated by build_Model() function.
