...
```         
> diff_gene(SE = MEL_GSE78220)[1:10,]
#               log2FC    p_value    q_value
#5S_rRNA    0.38635787 0.31208349  5.0572921
#5_8S_rRNA        -Inf 0.33704906  4.7230688
#7SK       -0.39756221 0.75486775  1.2212913
#A1BG      -0.20338673 0.56939277  2.4458805
#A1BG-AS1  -0.09587758 0.74221400  1.2947086
#A1CF       8.22716881 0.32787792  4.8428783
#A2M       -0.10791713 0.82113353  0.8558621
#A2M-AS1    0.29051262 0.53855358  2.6877108
#A2ML1      7.62209635 0.33351200  4.7688853
#A2ML1-AS1         Inf 0.02272428 16.4350982
```
# 2 Signature Assessment

## 2.1 Signature_assessment()
...
## 3.1 calculate_Signature_Score()

### 3.1.1 function

 By employing the calculate_Signature_Score() function, you can obtain a comprehensive signature score matrix for the 23 signatures in TigeR. In this matrix, the columns represent the signature scores, and the rows denote the sample names.
...
```         
calculate_Signature_Score(assay(MEL_GSE78220))[1:4, 1:6]
...
# 4 Tumor Microenviroment Deconvolution
...
### 6.1.1 function
&emsp;You can use **Dataloader()** function to load built-in data of tigeR package from ExperimentHub or local cache.
