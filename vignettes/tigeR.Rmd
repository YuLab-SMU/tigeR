...
## 2.1 calculate_Signature_Score()

### 2.1.1 function

 By using **calculate_Signature_Score()** function, you can get a overall Signature score matrix of 23 Signatures in tigeR which collumns are Signature score and rows are sample names.
